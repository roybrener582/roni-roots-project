...
const TRAITS = [
  {
    icon: '👭',
    name: 'חברותית',
    desc: 'אני מאוד עוזרת לחברות שלי, ומה שהן צריכות אני תמיד שם בשבילן.',
  ...
  },
  {
    icon: '🌸',
    name: 'רגישה',
    desc: 'אני מאוד רגישה להרבה דברים, אני בוכה בקלות.',
  ...
  },
  {
    icon: '🌙',
    name: 'פחדנית',
    desc: 'אני מפחדת ממלא דברים ונמנעת מעצמי ללכת ולעשות דברים.',
  ...
  },
  {
    icon: '🎁',
    name: 'נדיבה',
    desc: 'אני נדיבה כלפי כמעט כל דבר שמישהו מבקש ממני.',
  ...
  },
  {
    icon: '🤍',
    name: 'מתחשבת בזולת',
    desc: 'אני כמעט אף פעם לא מתחשבת רק בעצמי, אני עושה שכולם יהיו טוב ולא רק לי.',
