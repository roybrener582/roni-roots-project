...
const SECTIONS = [
  {
    ...
    paragraphs: [
      <>
        ...
        אהבתי לרקוד ולהתאמן בהתעמלות קרקע, לטייל עם המשפחה בכינרת וברמת הגולן,
        ולבלות עם חברות יקרות.
      </>,
      <>
        הזיכרונות האלה — הצחוקים, ההרפתקאות, הרגעים הקטנים — ממשיכים ללוות אותי
  ...
  },
  {
    ...
    paragraphs: [
      <>
        ...
        אני <mark className={styles.hi}>אמיצה</mark> — לא מפחדת להגיד מה שאני חושבת
  ...
  },
  {
    ...
    paragraphs: [
      ...
      <>
        אני רוצה ליצור סביבות נעימות לאנשים שאוהבת, ולגרום לכולם להרגיש טוב
