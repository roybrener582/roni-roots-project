...
const SECTIONS = [
  ...
  },
  {
    ...
    icon: '🌻',
    label: 'חברות',
    text: 'אני אוהבת מאוד לרקוד ולהיפגש עם חברות — חבורה מגובשת שהולכת יחד עוד מהגן, שבה מקפידים לפתור כל ריב באותו היום ומקבלים בברכה כל מצטרפת חדשה.',
    vars: {
      '--sc': '#c4728a',
  ...
  },
  {
    ...
    icon: '🫶',
    label: 'משפחה',
    text: 'מהמשפחה שלי ספגתי את ערך הנתינה והתרומה לאחר מבלי לצפות לתמורה. בסוף כל שנה אנחנו חוגגים יחד במסורת של אכילת גלידה.',
    vars: {
      '--sc': '#c4954a',
  ...
  },
  {
    ...
    icon: '🌿',
    label: 'קהילה',
    text: 'במושב שלי יש קהילה מדהימה שמתגייסת לעזור בכל מצב — מארוחות למשפחות אחרי לידה ועד עפיפוניאדה בסוכות.',
    vars: {
      '--sc': '#5a9e78',
  ...
  },
  {
    ...
    icon: '🕊️',
    label: 'מדינה',
    text: 'המדינה שלי היא המקום הכי חשוב לי בעולם. אני גאה בנופים, בחגים ובאתרים ההיסטוריים שלנו, ומרגישה שייכת לכאן בכל ליבי.',
    vars: {
      '--sc': '#5088b4',
