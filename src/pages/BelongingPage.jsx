...
const RINGS = [
  ...
  },
  {
    ...
    icon: '🫶',
    title: 'משפחתי',
    text: 'המסורת שלנו היא שכל סוף שנה אנחנו הולכים לאכול גלידה ביום האחרון ללימודים. אנחנו אוהבים לעשות יחד דברים כיפיים כמו לראות סרטים , לצאת לטיולים ולעשות הליכות משפחתיות.',
    size: 'lead',
  ...
  },
  {
    ...
    text: 'אצלנו במושב יש מסורת שנקראת (סירי לידה), שבה בכל פעם שנולד תינוק/ת אנשים מהמושב מכינים ארוחות למשפחה במשך חודש. בנוסף יש מסורת בסוכות להכין עפיפונים.',
    size: 'lead',
